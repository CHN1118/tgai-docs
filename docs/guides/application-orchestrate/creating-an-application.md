...
初次使用 TGAI 时，你可能对于应用创建比较陌生。为了帮助新手用户快速了解在 TGAI 上能够构建哪些类型的应用，TGAI 团队内的提示词工程师已经创建好了多场景、高质量的应用模板。
...
<figure><img src="../../.gitbook/assets/image (169).png" alt=""><figcaption><p>TGAI 应用模板</p></figcaption></figure>

### 创建一个新应用

如果你需要在 TGAI 上创建一个空白应用，你可以从导航选择 「工作室」 ，在应用列表内选择 「从空白创建 」。

<figure><img src="../../.gitbook/assets/image (167).png" alt=""><figcaption></figcaption></figure>

初次创建应用时，你可能需要先理解 TGAI 上 4 种不同应用类型的[基本概念](./#application_type)，分别是聊天助手、文本生成应用、Agent 和工作流。
...
TGAI DSL 是由 TGAI.AI 所定义的 AI 应用工程文件标准，文件格式为 YML。该标准涵盖应用在 TGAI 内的基本描述、模型参数、编排配置等信息。
:::
